package com.spotify.spotify.bg
...
import com.spotify.spotify.Application
import com.spotify.spotify.MainActivity
import com.spotify.spotify.R
import com.spotify.spotify.Settings
import com.spotify.spotify.constant.Action
import com.spotify.spotify.constant.Status
//import com.spotify.spotify.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import com.spotify.spotify.Application.Companion.notification
import com.spotify.spotify.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "spotify service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "Spotify")
