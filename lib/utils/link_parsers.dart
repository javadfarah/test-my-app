...
import 'package:spotify/utils/validators.dart';
...
abstract class LinkParser {
  static String generateSubShareLink(String url, [String? name]) {
    ...
    // return 'spotify://import/$modifiedUri';
    return '$modifiedUri';
  }

  // protocols schemas
  static const protocols = ['spotify', 'v2ray', 'v2rayn', 'v2rayng', 'clash', 'clashmeta', 'sing-box'];
